...
let
  ...
  fuae-launch = pkgs.fsuae-launcher.overrideAttrs (
    ...
    systems =
      ...
      rec {
        "nes" = {
          ...
          command = {
            "NESTopia (Standalone)" = {
              cmd = "nestopia --fullscreen %ROM%";
            };
            "FCEUX (Standalone)" = {
              cmd = "env QT_QPA_PLATFORM=xcb fceux %ROM% --fullscreen 1";
            };
            "Mesen (Standalone)" = {
              cmd = "env SDL_VIDEODRIVER=x11 mesen %ROM% --fullscreen";
            };
          };
        };
        "famicom" = {
        ...
        "snesna" = {
          ...
          command = {
            "ares" = {
              cmd = "${gamescopecmd} -- ares --fullscreen --system Super Famicom %ROM%";
            };
            "bsnes" = {
              cmd = "${gamescopecmd} -- bsnes --fullscreen %ROM%";
            };
            "Mesen (standalone)" = {
              cmd = "env SDL_VIDEODRIVER=x11 mesen --fullscreen %ROM%";
            };
          };
        };
        "sfc" = {
        ...
        "n64" = {
          ...
          command = {
            "Simple64 (Flatpak)" = {
              cmd = "flatpak run --filesystem=host:ro io.github.simple64.simple64 --nogui %ROM%";
            };
            "RMG (Flatpak)" = {
              cmd = "flatpak run --filesystem=host com.github.Rosalie241.RMG -f -n %ROM%";
            };
            "Mupen64Plus-Next (RetroArch)" = {
              cmd = "retroarch -L parallel_n64_libretro.so %ROM%";
            };
          };
        };
        "gc" = {
        ...
        "mastersystem" = {
          ...
          command = {
            "SMS Plus GX (RetroArch)" = {
              cmd = "retroarch -L genesis_plus_gx_libretro.so %ROM%";
            };
          };
        };
        "genesis" = {
          ...
          command = {
            "RetroArch (Blastem)" = {
              cmd = "retroarch -L blastem_libretro.so %ROM%";
            };
        ...
        "sega32xna" = {
          ...
          command = {
            "RetroArch (PicoDrive)" = {
              cmd = "retroarch -L picodrive_libretro.so %ROM%";
            };
          };
        };
        "saturn" = {
          ...
          command = {
            "RetroArch (Beetle Saturn)" = {
              cmd = "retroarch -L mednafen_saturn_libretro.so %ROM%";
            };
          };
        };
        "naomi" = {
        ...
        "psx" = {
          ...
          command = {
            "Duckstation (Standalone)" = {
              cmd = "duckstation-qt -bigpicture -batch -nogui -fullscreen %ROM%";
            };
          };
        };
        "ps2" = {
          ...
          command = {
            "PCSX2 (Standalone)" = {
              cmd = "pcsx2-qt -slowboot -bigpicture -fullscreen -nogui -batch %ROM%";
            };
          };
        };
        "psp" = {
        ...
        "xbox" = {
          ...
          command = {
            "XEMU" = {
              cmd = "xemu -full-screen -dvd_path %ROM% ";
            };
          };
        };
        "tg16" = {
        ...
        "tg-cd" = {
          ...
          command = {
            ...
            "Retroarch (Beetle PCE)" = {
              cmd = "retroarch -L ${pkgs.libretro.beetle-pce}${RetroarchCorePath}mednafen_pce_libretro.so %ROM%";
            };
          };
        };
        "pcenginecd" = {
